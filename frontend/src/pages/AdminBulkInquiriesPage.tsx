          ...
          <table>
            ...
            <tbody>
              {inquiries.map((inquiry) => (
                <tr key={inquiry.id}>
                  <td>
                    <strong>{inquiry.contactPerson}</strong>
                    <div>{inquiry.deliveryCity || "Address not provided"}</div>
                  </td>
                  <td>{inquiry.quoteStatus}</td>
                  <td>
                    {inquiry.phone}
                    <div>{inquiry.email || "Email not provided"}</div>
                  </td>
                  <td>
                    {inquiry.requirements}
                    <div>{inquiry.priorityRequest ? "Urgent" : "Normal"}</div>
                  </td>
                  <td>
